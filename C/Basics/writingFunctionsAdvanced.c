...
* given a quantity and a tax rate (between 0 and 1),
* at a unit price of 20 cents
...
int main() {
  ...
  printf("The amount owed for the first order of ping-pong balls is: "
         "%d cents\n", order1_owed);
  printf("The amount owed for the second order of ping-pong balls is: "
         "%d cents\n", order2_owed);
  printf("The amount owed for the third order of ping-pong balls is: "
         "%d cents\n", order3_owed);
...
long calculate_total(int quantity, double tax_rate) {
  ...
  return lround(quantity * 20 * (1.0 - discount) * (1.0 + tax_rate));
}
